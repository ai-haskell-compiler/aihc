...
mkUTF8 failureMode = nameOnlyEncoding ("UTF-8" ++ codingFailureModeSuffix failureMode)

utf8_bom :: TextEncoding
utf8_bom = mkUTF8_bom ErrorOnCodingFailure

mkUTF8_bom :: CodingFailureMode -> TextEncoding
mkUTF8_bom failureMode = nameOnlyEncoding ("UTF-8BOM" ++ codingFailureModeSuffix failureMode)
