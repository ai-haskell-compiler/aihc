...
| aihc-base / base   | <!-- AUTO-GENERATED: START base-progress --> `1813/10059` (`18.02%`) ○○○○○ <!-- AUTO-GENERATED: END base-progress -->                             |
| &nbsp; | &nbsp; |
| TypeCheck Tests    | <!-- AUTO-GENERATED: START tc-progress --> `538/539` (`99.81%`) ●●●●○ <!-- AUTO-GENERATED: END tc-progress -->                                |
| Resolve Tests      | <!-- AUTO-GENERATED: START resolve-progress --> `106/106` (`100.00%`) ●●●●● <!-- AUTO-GENERATED: END resolve-progress -->                      |
