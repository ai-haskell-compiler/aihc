...
| Parser Tests       | <!-- AUTO-GENERATED: START parser-progress --> `2351/2351` (`100.00%`) ●●●●● <!-- AUTO-GENERATED: END parser-progress -->                     |
