...
module Aihc.Fc2.Desugar.Core.Match
  ( dsPatternPure,
    dsDataConPure,
    numericRuntimeRep,
  )
...
dsPatternPure :: PackageId -> Pattern -> (CoreAltCon, [Text])
...
primitiveOrigin :: PackageId -> Text -> Text -> CoreConstructorId
primitiveOrigin = CoreConstructorId

constructorOrigin :: Name -> CoreConstructorId
