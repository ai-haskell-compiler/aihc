...
docTokenKind kind =
  case kind of
    ...
    TkReservedArrowTailLeft -> "TkReservedArrowTailLeft"
    TkReservedArrowTailLeftDouble -> "TkReservedArrowTailLeftDouble"
    TkReservedArrowTailRight -> "TkReservedArrowTailRight"
    TkReservedArrowTailRightDouble -> "TkReservedArrowTailRightDouble"
