...
loadPrimitiveModules = do
  ...
  mapM (loadOne sourceRoot) ["GHC/Classes.hs", "GHC/Types.hs", "GHC/Prim.hs", "Aihc/Prim/IO.hs", "GHC/Prim/IO.hs", "GHC/Prim/Base.hs", "GHC/Prim/Integer.hs", "GHC/Prim/Natural.hs", "GHC/Tuple.hs"]
  where
