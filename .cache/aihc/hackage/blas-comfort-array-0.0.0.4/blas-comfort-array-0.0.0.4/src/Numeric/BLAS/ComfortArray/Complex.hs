...
newtype AXPY a = AXPY {getAXPY :: Int -> (Complex a) -> Array ZeroInt (Complex a) -> Int -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype GBMV a = GBMV {getGBMV :: Char -> Int -> Int -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> Array ZeroInt (Complex a) -> Int -> (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype GEMM a = GEMM {getGEMM :: Char -> Char -> Int -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> (Complex a) -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype GEMV a = GEMV {getGEMV :: Char -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> Array ZeroInt (Complex a) -> Int -> (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype GERC a = GERC {getGERC :: Int -> (Complex a) -> Array ZeroInt (Complex a) -> Int -> Array ZeroInt (Complex a) -> Int -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype GERU a = GERU {getGERU :: Int -> (Complex a) -> Array ZeroInt (Complex a) -> Int -> Array ZeroInt (Complex a) -> Int -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype HBMV a = HBMV {getHBMV :: Char -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> Array ZeroInt (Complex a) -> Int -> (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype HEMM a = HEMM {getHEMM :: Char -> Char -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> (Complex a) -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype HEMV a = HEMV {getHEMV :: Char -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> Array ZeroInt (Complex a) -> Int -> (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype HER a = HER {getHER :: Char -> a -> Array ZeroInt (Complex a) -> Int -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype HER2 a = HER2 {getHER2 :: Char -> (Complex a) -> Array ZeroInt (Complex a) -> Int -> Array ZeroInt (Complex a) -> Int -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype HER2K a = HER2K {getHER2K :: Char -> Char -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> a -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype HERK a = HERK {getHERK :: Char -> Char -> Int -> a -> Array (ZeroInt,ZeroInt) (Complex a) -> a -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype HPMV a = HPMV {getHPMV :: Char -> Int -> (Complex a) -> Array ZeroInt (Complex a) -> Array ZeroInt (Complex a) -> Int -> (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype HPR a = HPR {getHPR :: Char -> Int -> a -> Array ZeroInt (Complex a) -> Int -> IOArray ZeroInt (Complex a) -> IO ()}
...
newtype HPR2 a = HPR2 {getHPR2 :: Char -> Int -> (Complex a) -> Array ZeroInt (Complex a) -> Int -> Array ZeroInt (Complex a) -> Int -> IOArray ZeroInt (Complex a) -> IO ()}
...
newtype IAMAX a = IAMAX {getIAMAX :: Int -> Array ZeroInt (Complex a) -> Int -> IO CInt}
...
newtype RROT a = RROT {getRROT :: Int -> IOArray ZeroInt (Complex a) -> Int -> IOArray ZeroInt (Complex a) -> Int -> a -> a -> IO ()}
...
newtype RSCAL a = RSCAL {getRSCAL :: Int -> a -> IOArray ZeroInt (Complex a) -> Int -> IO ()}

rscal :: Class.Real a => Int -> a -> IOArray ZeroInt (Complex a) -> Int -> IO ()
rscal = getRSCAL $ Class.switchReal (RSCAL C.rscal) (RSCAL Z.rscal)


newtype SCAL a = SCAL {getSCAL :: Int -> (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}

scal :: Class.Real a => Int -> (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()
scal = getSCAL $ Class.switchReal (SCAL C.scal) (SCAL Z.scal)


newtype SWAP a = SWAP {getSWAP :: Int -> IOArray ZeroInt (Complex a) -> Int -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype SYMM a = SYMM {getSYMM :: Char -> Char -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> (Complex a) -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype SYR2K a = SYR2K {getSYR2K :: Char -> Char -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> (Complex a) -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype SYRK a = SYRK {getSYRK :: Char -> Char -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> (Complex a) -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype TBMV a = TBMV {getTBMV :: Char -> Char -> Char -> Int -> Array (ZeroInt,ZeroInt) (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype TBSV a = TBSV {getTBSV :: Char -> Char -> Char -> Int -> Array (ZeroInt,ZeroInt) (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype TPMV a = TPMV {getTPMV :: Char -> Char -> Char -> Int -> Array ZeroInt (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype TPSV a = TPSV {getTPSV :: Char -> Char -> Char -> Int -> Array ZeroInt (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype TRMM a = TRMM {getTRMM :: Char -> Char -> Char -> Char -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype TRMV a = TRMV {getTRMV :: Char -> Char -> Char -> Array (ZeroInt,ZeroInt) (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
...
newtype TRSM a = TRSM {getTRSM :: Char -> Char -> Char -> Char -> Int -> (Complex a) -> Array (ZeroInt,ZeroInt) (Complex a) -> IOArray (ZeroInt,ZeroInt) (Complex a) -> IO ()}
...
newtype TRSV a = TRSV {getTRSV :: Char -> Char -> Char -> Array (ZeroInt,ZeroInt) (Complex a) -> IOArray ZeroInt (Complex a) -> Int -> IO ()}
