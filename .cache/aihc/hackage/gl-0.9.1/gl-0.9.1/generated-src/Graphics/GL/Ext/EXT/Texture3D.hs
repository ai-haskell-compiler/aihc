...
pattern GL_MAX_3D_TEXTURE_SIZE_EXT  :: (Eq a, Num a) => a

pattern GL_MAX_3D_TEXTURE_SIZE_EXT = 0x8073

pattern GL_PACK_IMAGE_HEIGHT_EXT  :: (Eq a, Num a) => a

pattern GL_PACK_IMAGE_HEIGHT_EXT = 0x806C

pattern GL_PACK_SKIP_IMAGES_EXT  :: (Eq a, Num a) => a

pattern GL_PACK_SKIP_IMAGES_EXT = 0x806B

pattern GL_PROXY_TEXTURE_3D_EXT  :: (Eq a, Num a) => a

pattern GL_PROXY_TEXTURE_3D_EXT = 0x8070

pattern GL_TEXTURE_3D_EXT  :: (Eq a, Num a) => a

pattern GL_TEXTURE_3D_EXT = 0x806F

pattern GL_TEXTURE_DEPTH_EXT  :: (Eq a, Num a) => a

pattern GL_TEXTURE_DEPTH_EXT = 0x8071

pattern GL_TEXTURE_WRAP_R_EXT  :: (Eq a, Num a) => a

pattern GL_TEXTURE_WRAP_R_EXT = 0x8072

pattern GL_UNPACK_IMAGE_HEIGHT_EXT  :: (Eq a, Num a) => a

pattern GL_UNPACK_IMAGE_HEIGHT_EXT = 0x806E

pattern GL_UNPACK_SKIP_IMAGES_EXT  :: (Eq a, Num a) => a
