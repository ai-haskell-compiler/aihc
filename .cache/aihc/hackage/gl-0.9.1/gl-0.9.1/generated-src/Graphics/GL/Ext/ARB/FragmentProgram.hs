...
pattern GL_FRAGMENT_PROGRAM_ARB  :: (Eq a, Num a) => a

pattern GL_FRAGMENT_PROGRAM_ARB = 0x8804

pattern GL_MAX_PROGRAM_ALU_INSTRUCTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_MAX_PROGRAM_ALU_INSTRUCTIONS_ARB = 0x880B

pattern GL_MAX_PROGRAM_NATIVE_ALU_INSTRUCTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_MAX_PROGRAM_NATIVE_ALU_INSTRUCTIONS_ARB = 0x880E

pattern GL_MAX_PROGRAM_NATIVE_TEX_INDIRECTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_MAX_PROGRAM_NATIVE_TEX_INDIRECTIONS_ARB = 0x8810

pattern GL_MAX_PROGRAM_NATIVE_TEX_INSTRUCTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_MAX_PROGRAM_NATIVE_TEX_INSTRUCTIONS_ARB = 0x880F

pattern GL_MAX_PROGRAM_TEX_INDIRECTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_MAX_PROGRAM_TEX_INDIRECTIONS_ARB = 0x880D

pattern GL_MAX_PROGRAM_TEX_INSTRUCTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_MAX_PROGRAM_TEX_INSTRUCTIONS_ARB = 0x880C

pattern GL_PROGRAM_ALU_INSTRUCTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_PROGRAM_ALU_INSTRUCTIONS_ARB = 0x8805

pattern GL_PROGRAM_NATIVE_ALU_INSTRUCTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_PROGRAM_NATIVE_ALU_INSTRUCTIONS_ARB = 0x8808

pattern GL_PROGRAM_NATIVE_TEX_INDIRECTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_PROGRAM_NATIVE_TEX_INDIRECTIONS_ARB = 0x880A

pattern GL_PROGRAM_NATIVE_TEX_INSTRUCTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_PROGRAM_NATIVE_TEX_INSTRUCTIONS_ARB = 0x8809

pattern GL_PROGRAM_TEX_INDIRECTIONS_ARB  :: (Eq a, Num a) => a

pattern GL_PROGRAM_TEX_INDIRECTIONS_ARB = 0x8807

pattern GL_PROGRAM_TEX_INSTRUCTIONS_ARB  :: (Eq a, Num a) => a
