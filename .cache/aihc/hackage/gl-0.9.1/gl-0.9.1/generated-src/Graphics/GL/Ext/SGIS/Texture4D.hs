...
pattern GL_MAX_4D_TEXTURE_SIZE_SGIS  :: (Eq a, Num a) => a

pattern GL_MAX_4D_TEXTURE_SIZE_SGIS = 0x8138

pattern GL_PACK_IMAGE_DEPTH_SGIS  :: (Eq a, Num a) => a

pattern GL_PACK_IMAGE_DEPTH_SGIS = 0x8131

pattern GL_PACK_SKIP_VOLUMES_SGIS  :: (Eq a, Num a) => a

pattern GL_PACK_SKIP_VOLUMES_SGIS = 0x8130

pattern GL_PROXY_TEXTURE_4D_SGIS  :: (Eq a, Num a) => a

pattern GL_PROXY_TEXTURE_4D_SGIS = 0x8135

pattern GL_TEXTURE_4DSIZE_SGIS  :: (Eq a, Num a) => a

pattern GL_TEXTURE_4DSIZE_SGIS = 0x8136

pattern GL_TEXTURE_4D_BINDING_SGIS  :: (Eq a, Num a) => a

pattern GL_TEXTURE_4D_BINDING_SGIS = 0x814F

pattern GL_TEXTURE_4D_SGIS  :: (Eq a, Num a) => a

pattern GL_TEXTURE_4D_SGIS = 0x8134

pattern GL_TEXTURE_WRAP_Q_SGIS  :: (Eq a, Num a) => a

pattern GL_TEXTURE_WRAP_Q_SGIS = 0x8137

pattern GL_UNPACK_IMAGE_DEPTH_SGIS  :: (Eq a, Num a) => a

pattern GL_UNPACK_IMAGE_DEPTH_SGIS = 0x8133

pattern GL_UNPACK_SKIP_VOLUMES_SGIS  :: (Eq a, Num a) => a
