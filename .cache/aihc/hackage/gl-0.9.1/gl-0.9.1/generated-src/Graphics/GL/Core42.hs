...
pattern GL_COMPRESSED_RGBA_BPTC_UNORM  :: (Eq a, Num a) => a

pattern GL_COMPRESSED_RGBA_BPTC_UNORM = 0x8E8C

pattern GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT  :: (Eq a, Num a) => a

pattern GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT = 0x8E8E

pattern GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT  :: (Eq a, Num a) => a

pattern GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT = 0x8E8F

pattern GL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM  :: (Eq a, Num a) => a
