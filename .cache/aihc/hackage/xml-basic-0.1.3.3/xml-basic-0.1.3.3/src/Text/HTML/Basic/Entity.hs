...
mapCharToNameInternetExploder =
   Map.fromList $ map swap listInternetExploder


mapNameToUpper :: Map.Map String String
mapNameToUpper =
   Map.fromList $ map swap upperLowerPairs

mapNameToLower :: Map.Map String String
mapNameToLower =
   Map.fromList upperLowerPairs
...
upperLowerPairs =
   mapMaybe
      (\(name,_) ->
         ...
         in  toMaybe
                 (lname /= name && Map.member lname mapNameToChar)
                 (name,lname))
      listAdditional
...
list :: [(Name, Char)]
list =
   XMLEnt.list ++ listAdditional

listInternetExploder :: [(Name, Char)]
listInternetExploder =
   XMLEnt.listInternetExploder ++ listAdditional
