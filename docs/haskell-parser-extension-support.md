...
| ExplicitForAll | Supported | 11/11 |
| ExplicitLevelImports | Supported | 4/4 |
| ExplicitNamespaces | In Progress | 4/8 |
| ExtendedLiterals | Supported | 2/2 |
| FlexibleContexts | Supported | 3/3 |
| FlexibleInstances | Supported | 7/7 |
| ForeignFunctionInterface | In Progress | 38/39 |
| FunctionalDependencies | Supported | 7/7 |
| GADTSyntax | Supported | 9/9 |
| GADTs | In Progress | 6/8 |
...
| MagicHash | In Progress | 4/5 |
| MultiParamTypeClasses | Supported | 16/16 |
| MultiWayIf | In Progress | 3/4 |
