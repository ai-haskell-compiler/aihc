...
| base16-bytestring | 1.0.2.0 | hackage:1 | bytestring |
| base64-bytestring | 1.2.1.0 | hackage:1 | bytestring |
| containers | 0.7 | hackage:0 | array, deepseq |
...
| half | 0.3.3 | hackage:3 | binary, deepseq |
...
| hpke | 0.0.0 | hackage:1 | base16-bytestring, bytestring, crypton, memory |
| network-byte-order | 0.1.8 | hackage:0 | bytestring |
| old-locale | 1.0.0.7 | hackage:2 |  |
| old-time | 1.1.1.0 | hackage:0 | old-locale |
...
| time-hourglass | 0.3.0 | hackage:0 | deepseq |
...
| ech-config | 0.0.1 | hackage:1 | base16-bytestring, bytestring, filepath, network-byte-order |
...
| cborg | 0.2.10.0 | hackage:3 | array, bytestring, containers, deepseq, ghc-bignum, half, primitive, text |
...
| base16 | 1.0 | hackage:4 | bytestring, deepseq, primitive, text, text-short |
| base64 | 1.0 | hackage:3 | bytestring, deepseq, text, text-short |
| crypton-asn1-types | 0.4.1 | hackage:0 | base16, bytestring, time-hourglass |
| crypton-asn1-encoding | 0.10.0 | hackage:0 | bytestring, crypton-asn1-types, time-hourglass |
| crypton-asn1-parse | 0.10.0 | hackage:0 | bytestring, crypton-asn1-types |
| crypton-pem | 0.3.0 | hackage:0 | base64, bytestring, deepseq, text |
| crypton-x509 | 1.8.0 | hackage:1 | bytestring, containers, crypton, crypton-asn1-encoding, crypton-asn1-parse, crypton-asn1-types, crypton-pem, memory, time-hourglass, transformers |
...
| crypton-x509-store | 1.8.0 | hackage:0 | bytestring, containers, crypton, crypton-asn1-encoding, crypton-asn1-types, crypton-pem, crypton-x509, directory, filepath, mtl, unix |
...
| crypton-x509-validation | 1.8.0 | hackage:1 | bytestring, containers, crypton, crypton-asn1-encoding, crypton-asn1-types, crypton-pem, crypton-x509, crypton-x509-store, data-default, iproute, memory, mtl, time-hourglass |
...
| crypton-x509-system | 1.8.0 | hackage:0 | bytestring, containers, crypton-pem, crypton-x509, crypton-x509-store, directory, filepath, mtl, process |
...
| unix-time | 0.4.17 | hackage:0 | binary, bytestring, old-time |
...
| serialise | 0.2.6.1 | hackage:5 | array, bytestring, cborg, containers, half, hashable, primitive, strict, text, these, time, unordered-containers, vector |
...
| tls | 2.2.2 | hackage:1 | base16-bytestring, bytestring, cereal, crypton, crypton-asn1-encoding, crypton-asn1-types, crypton-x509, crypton-x509-store, crypton-x509-validation, data-default, ech-config, hpke, memory, mtl, network, random, serialise, transformers, unix-time, zlib |
