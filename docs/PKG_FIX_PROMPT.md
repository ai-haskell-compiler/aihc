...
Fix the parsing issue that prevents '{{PACKAGE_NAME}}' from parsing successfully. Include unit tests, golden tests, oracle tests, and Hedgehog properties if applicable. Open a PR when done.
