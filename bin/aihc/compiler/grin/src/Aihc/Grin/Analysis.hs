...
freeExprVars expression =
  case expression of
    ...
    GrinKeepAlive _ function arguments -> freeValueVars function <> foldMap freeValueVars arguments
  ...
  where
    ...
    exprUniques expr =
      case expr of
        ...
        GrinKeepAlive _ function arguments -> concatMap valueUnique (function : arguments)
