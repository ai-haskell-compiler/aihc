              ...
              source =
                unlines
                  [ "#include \"aihc_runtime.h\"",
                    ...
                    "static const AihcInfo box_info = {2, 0, 1, 0, pointer_field, 0, 0, AIHC_FRAME_NONE, AIHC_OBJECT_NODE};",
                    "static const AihcInfo thunk_info = {4, 0, 0, 0, 0, 0, 0, AIHC_FRAME_NONE, AIHC_OBJECT_THUNK};",
                    "static const AihcInfo partial_final_info = {3, 0, 2, 0, pointer_then_scalar, 0, 0, AIHC_FRAME_NONE, AIHC_OBJECT_NODE};",
                    "static const AihcInfo partial_one_info = {3, 0, 1, 1, pointer_then_scalar, &partial_final_info, 0, AIHC_FRAME_NONE, AIHC_OBJECT_PARTIAL_CONSTRUCTOR};",
                    "static const AihcInfo partial_info = {3, 0, 0, 2, 0, &partial_one_info, 0, AIHC_FRAME_NONE, AIHC_OBJECT_PARTIAL_CONSTRUCTOR};",
                    "static const AihcInfo continuation_final_info = {8, entry_8, 1, 0, pointer_field, 0, 0, AIHC_FRAME_NORMAL, AIHC_OBJECT_CLOSURE};",
                    "static const AihcInfo continuation_info = {8, entry_8, 0, 1, 0, &continuation_final_info, 0, AIHC_FRAME_NORMAL, AIHC_OBJECT_CLOSURE};",
                    "static const AihcInfo action_final_info = {9, entry_9, 0, 0, 0, 0, 0, AIHC_FRAME_NONE, AIHC_OBJECT_CLOSURE};",
                    "static const AihcInfo action_info = {9, entry_9, 0, 1, 0, &action_final_info, 0, AIHC_FRAME_NONE, AIHC_OBJECT_CLOSURE};",
                    "static const AihcInfo thread_done_final_info = {10, entry_10, 1, 0, pointer_field, 0, 0, AIHC_FRAME_STOP, AIHC_OBJECT_CLOSURE};",
                    "static const AihcInfo thread_done_info = {10, entry_10, 0, 1, 0, &thread_done_final_info, 0, AIHC_FRAME_STOP, AIHC_OBJECT_CLOSURE};",
                    "static const AihcInfo yield_final_info = {12, entry_12, 0, 0, 0, 0, 0, AIHC_FRAME_NONE, AIHC_OBJECT_CLOSURE};",
                    "static const AihcInfo yield_info = {12, entry_12, 0, 1, 0, &yield_final_info, 0, AIHC_FRAME_NONE, AIHC_OBJECT_CLOSURE};",
...
testNativeScheduler = do
  ...
  assertBool "captures argc and argv before machine startup" ("bl _aihc_program_arguments_initialize" `T.isInfixOf` entryAssembly)
  assertBool "emits fork state operation" ("bl _aihc_fork" `T.isInfixOf` moduleAssembly)
  assertBool "emits yield state operation" ("bl _aihc_yield" `T.isInfixOf` moduleAssembly)
  assertBool "emits child completion transfer" ("bl _aihc_thread_done" `T.isInfixOf` entryAssembly)
...
testNativeSynchronousException = do
  ...
  assertBool "emits the shared raise transfer" ("bl _aihc_raise" `T.isInfixOf` moduleAssembly)
  when (arch == "aarch64" && os == "darwin") $
...
testNativeStdioScheduler = do
  ...
  assertBool "submits a generic write through the runtime ABI" ("bl _aihc_io_submit_write" `T.isInfixOf` assembly)
